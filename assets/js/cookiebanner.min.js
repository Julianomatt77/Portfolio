...
!(function (context) {
  ...
  function contentLoaded(e, t) {
    ...
    if ("complete" == n.readyState) t.call(e, "lazy");
      ...
      n[a](c + "DOMContentLoaded", l, !1),
        n[a](c + "readystatechange", l, !1),
        e[a](c + "load", l, !1);
    }
  }
  var win = context,
    ...
    Utils = {
      ...
      fade_out: function (e, t) {
        if ("undefined" != typeof e) {
          e.style.opacity = 1;
          var i = t / 1e3;
          (e.style.transition = "opacity " + i + "s ease"),
            (e.style.opacity = 0),
            setTimeout(function () {
            ...
            if (Object.prototype.hasOwnProperty.call(attribs, key)) {
              ...
              if (/^data-/.test(attr.name)) {
                var camelized = Utils.camelize(attr.name.substr(5)),
                  isFunction = 0 === camelized.lastIndexOf("on", 0);
      ...
      find_script_by_id: function (e) {
        for (
          var t = doc.getElementsByTagName("script"), i = 0, o = t.length;
          i < o;
          i++
        )
  ...
  (Cookiebanner.prototype = {
    ...
    init: function (e) {
      ...
      var t =
          "Ce site utilise des cookies. En continuant de naviguer, vous acceptez leur utilisation.",
        i = "En savoir plus";
      if (
      ...
      e &&
        ((e = Utils.normalize_keys(e)),
        (this.options = Utils.merge(this.options, e))),
        (global_instance_name = this.options.instance),
        (this.options.zindex = parseInt(this.options.zindex, 10)),
        (this.options.mask = Utils.str2bool(this.options.mask)),
        (this.options.closePrecedes = Utils.str2bool(
          this.options.closePrecedes
        )),
        "string" == typeof this.options.expires &&
          ("function" == typeof context[this.options.expires]
            ? (this.options.expires = context[this.options.expires])
            : Utils.is_numeric(this.options.expires) &&
              (this.options.expires = Number(
                parseFloat(this.options.expires)
              ))),
    ...
    agree_and_close: function () {
      if (
        (this.options.debug || this.agree(),
        !this.options.delayBeforeClose ||
          isNaN(parseFloat(this.options.delayBeforeClose)) ||
          !isFinite(this.options.delayBeforeClose))
      )
        return this.close();
      var e = this;
      setTimeout(function () {
    ...
    unload: function () {
      return (
        ...
        (context[global_instance_name] = void 0),
        !0
      );
    },
    insert: function () {
      ...
      var o =
          ...
          "</div>",
        n = "";
      null !== this.options.moreinfoClass &&
        (n = ' class="' + this.options.moreinfoClass + '" ');
      var s =
        "<span>" +
        this.options.message +
        (this.options.linkmsg
          ? " <a" + n + ">" + this.options.linkmsg + "</a>"
          : "") +
        "</span>";
      this.options.closePrecedes
        ? (i.innerHTML = o + s)
      ...
      l && "function" == typeof l && l(this),
        "fade" === this.options.effect
          ? ((this.element.style.opacity = 0), Utils.fade_in(this.element))
          : (this.element.style.opacity = 1);
    },
  }),
    script_el_invoker &&
      (context[global_instance_name] ||
